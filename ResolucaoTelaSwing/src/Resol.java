...
public class Resol extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblResol.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblResol.setForeground(new java.awt.Color(153, 153, 153));
        lblResol.setText("Aperte o botão");

        btnResol.setText("Mostrar Resolução");
    ...
    private void btnResolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResolActionPerformed
        ...
        String hei = Double.toString(res.getHeight());
        String wid = Double.toString(res.getWidth());
        lblResol.setText(hei + " x " + wid);
